...
export default function AuthModal({ onLoginSuccess }) {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'var(--bg-cream)', padding: '24px' }}>
      <div className="beige-card" style={{ width: '100%', maxWidth: '440px', display: 'flex', flexDirection: 'column', padding: '32px', background: '#fdfcf7', boxShadow: 'var(--shadow-floating)' }}>
        
        {/* Branding */}
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <div className="brand-icon-box" style={{ margin: '0 auto 12px auto', width: '52px', height: '52px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0c3259', color: '#fff', borderRadius: '14px' }}>
